...
final class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    private func showControlPanelIfRequested() {
        guard UserDefaults.standard.bool(forKey: "CmdQGuard.showSettingsOnLaunch") else { return }
    ...
    private func hideDockIfLaunchingWithoutVisibleWindow() {
        guard OnboardingState.isComplete,
              !UserDefaults.standard.bool(forKey: "CmdQGuard.showSettingsOnLaunch") else { return }
    ...
    private func installedAppsForControlPanel() -> [InstalledApp] {
        #if DEBUG
        if UserDefaults.standard.bool(forKey: "CmdQGuard.useUITestAppInventory") {
            return [
                InstalledApp(
